	...
	<div id="btl-content">
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<div id="social-connect">
				...
				<ul>
					<?php if($enable_fb):?><li id="bt-facebook"><a href="JavaScript:newPopup('<?php echo $dialog_urlFB?>','<?php echo JText::sprintf ( 'MOD_BT_LOGIN_CONNECT_TITLE', 'Facebook'); ?>',600,400);"><img alt="facebook" src="<?php echo JURI::root(); ?>/templates/bt_real_estate/html/mod_bt_sociallogin/images/fb.png"/></a></li><?php endif;?>
					<?php if($enable_gg):?><li id="bt-google"><a href="JavaScript:newPopup('<?php echo $dialog_urlGG?>','<?php echo JText::sprintf ( 'MOD_BT_LOGIN_CONNECT_TITLE', 'Google'); ?>',600,400);"><img alt="google" src="<?php echo JURI::root(); ?>/templates/bt_real_estate/html/mod_bt_sociallogin/images/gg.png" /></a></li><?php endif;?>
					<?php if($enable_twitter):?><li id="bt-twitter"><a href="JavaScript:newPopup('<?php echo $dialog_urlTT?>','<?php echo JText::sprintf ( 'MOD_BT_LOGIN_CONNECT_TITLE', 'Twitter'); ?>',600,400);"><img alt="twitter" src="<?php echo JURI::root(); ?>/templates/bt_real_estate/html/mod_bt_sociallogin/images/tt.png"/></a></li><?php endif;?>
				</ul>
			</div>
			<?php endif;?>
		...
		<div id="btl-content-registration"  class="btl-content-block">			
			...
			<form id="btl-form-register" name="btl-formregistration" class="btl-formregistration form-validate" onsubmit="return registerAjax();"  autocomplete="off">
					...
					<div class="bt-scroll">
						...
						<!-- show captcha -->
						<?php if($enabledCaptcha == 'recaptcha'):?>
							<?php if ($captchaField): ?>
								<div class="btl-field">
									<div class="btl-label">
...
var btlOpt = 
{
	...
	DIREC					:'<?php echo $document->direction;?>'
}
