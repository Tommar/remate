...
<form action="<?php echo JURI::root(true); ?>/index.php" method="post" id="comment-form" class="form-validate">	
	...
	<?php endif; ?>
	<span class="bt_buttom">
		<button type="submit" class="button" id="submitCommentButton" value="<?php echo JText::_('K2_SUBMIT_COMMENT'); ?>" ><?php echo JText::_('K2_SUBMIT_COMMENT'); ?></button>
	</span>
