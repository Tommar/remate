...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="userItemList">
		...
		foreach ($this->items as $item): 
			//$stt++; 
			//echo'<div class="icon_number"><span> '; echo $stt; echo ' </span></div>';
		?>
			...
			<div class="userItemHeader">			
			  ...
			  <div class="itembasicinfo">
					...
					<span class="userItemDateCreated">
						<?php echo JText::_('K2_POSTED_ON_DAY_BT').' '; ?><strong><?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_BT')); ?></strong>
					</span>
					<?php endif; ?>			  
					...
					<div class="userItemCommentsLink">
						...
						<?php else: ?>
							...
							<a href="<?php echo $item->link; ?>#itemCommentsAnchor">
								<span><?php echo $item->numOfComments; ?> <?php echo ($item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?></span>
							</a>
							<?php else: ?>
							<a href="<?php echo $item->link; ?>#itemCommentsAnchor">
	...
	<!-- Pagination -->
	<?php if(count($this->pagination->getPagesLinks()) && $this->pagination->get('pages.total') > 1): ?>
