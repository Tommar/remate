...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<!--
	<div class="title_page k2category item">
		<?php echo $this->item->category->name; ?>
	</div>
	-->
	<div class="contentItemK2">
	  ...
	  <?php endif; ?>
		...
		<div class="itemdetailbasicinfo">
			...
			<span class="itemDateCreated">
				<?php echo JText::_('K2_POSTED_DAY_BT').': '; ?><strong><?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_BT')); ?></strong>
			</span>
			<?php endif; ?>			
  ...
  <div class="itemBody">
	  ...
	  <!-- Item extra fields -->
	  <div class="itemExtraFields" style="display:none;">
  ...
  <div class="relateinfor">
	<?php if($this->item->params->get('itemHits')): ?>
		<!-- Item Hits -->
		<div class="itemHits">
			<span><?php echo JText::_('K2_READ'); ?> </span><?php echo $this->item->hits; ?>
		</div>
	<?php endif; ?>		
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">	    	
			...
			<span class="commentDate">
		    	<?php echo JText::_('K2_COMMENTED_ON').' '; ?><?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC2_BT')); ?>
		    </span>
