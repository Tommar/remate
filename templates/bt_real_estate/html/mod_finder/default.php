...
<div class="bt-text-search-form">
	<span class="bt-text-search"><?php echo JText::_('BT_TEXT_SEARCH'); ?>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		jQuery('.bt-text-search').hover(function(){
			jQuery('.bt-text-search .finder').stop().slideDown();
			jQuery('.btl-content-block').hide();
		},function(){
			jQuery('.bt-text-search .finder').stop().slideUp();
		})
	})
</script>
