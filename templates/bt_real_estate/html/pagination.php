...
function pagination_list_render($list)
{
	...
	$html = "<ul class=\"pagination-list pagination-label\">";
	//$html .= '<li><a>&larr;</a></li>';
  	$html .= $list['start']['data'];
	$html .= $list['previous']['data'];
	$html .= "</ul>";
	$html .= "<ul class=\"pagination-list pagination-number\">";
...
function pagination_item_active(&$item)
{
		...
		{
			return "<li class=\"". $item->text ."\"><a title=\"" . $item->text . "\" href=\"" . $item->link . "\">" . $item->text . "</a></li>";
		}
}

function pagination_item_inactive(&$item) {

	return "<li class=\"". $item->text ." disabled\"><a>".$item->text."</a></li>";
}
?>