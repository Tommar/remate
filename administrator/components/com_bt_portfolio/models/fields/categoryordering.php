...
class JFormFieldCategoryOrdering extends JFormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since	1.6
	 */
	protected $type = 'CategoryOrdering';
	...
	protected function getInput()
	{
		...
		$categoryId	= (int) $this->form->getValue('parent_id');

		// Build the query for the ordering list.
		$query = 'SELECT ordering AS value, title AS text' .
				' FROM #__bt_portfolio_categories' .
