...
<div class="btp">
	...
	<div class="btp-list" style="display:none">
		...
		?>
		<div data-id="pid<?php echo $item->id; ?>" class="btp-item p<?php echo $item->category_id?> <?php if($i==0) echo 'item-first'; else if ($i == $total) echo  'item-last';?>" <?php if ($item->category_id != $activeID && !$all) echo 'style="display:none"';	?>>
