...
class JFormFieldWarning extends JFormField {
    ...
    protected function getInput() {
        ...
        $saveDir = JPATH_ROOT . '/modules/mod_btimagegallery/images';
        ...
        if (!is_writable($saveDir)) {
            ...
            if (JFolder::exists($saveDir) && !is_writable($saveDir)) {
                ...
                if (JFolder::exists($saveDir . '/crop') && !is_writable($saveDir . '/crop')) {
                    $html.='<li>Folder <b>images/crop</b> of module can not be written. Check chmod, please.</li>';
                }
